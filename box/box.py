...
flat = True
#midi_sock_count = 7  # Router 7x7
#midi_sock_count = 4  # Router 4x4
#midi_sock_count = 3  # Splitter x6
midi_sock_count = 2   # MIDI to DIN-Sync
#midi_sock_count = 1
...
if (midi_sock_count == 4 or midi_sock_count == 2) and flat:
    board_length = 100
    board_width = 80
    board_thickness = 1.5
    board_clearance = 0.6
...
if 'usb_width' not in locals():
    usb_width = 12

if 'usb_height' not in locals():
    usb_height = 11
...
# move the cover up
cover = cover.translate((0, 0, box_inner_height * 1.0 + fillet_r))
